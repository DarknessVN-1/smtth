...
task.spawn(function()
    while task.wait(0.1) do
        ...
        local enemies = getE()
        if #enemies ~= lastCount then
            lastCount = #enemies
            log("👾 Enemies alive: "..lastCount, Color3.fromRGB(200,200,255))
        end
...
log("✅ Auto Target + Enemy Count + Precise Dodge Ready", Color3.fromRGB(0,255,0))
