...
local function danger(z)
    return z:IsA("BasePart") and (z.Size.Magnitude>5) and (hrp.Position-z.Position).Magnitude<z.Size.Magnitude/2
end
local function watch(e)
    ...
    e.DescendantAdded:Connect(function(o)
        if danger(o) then
            ...
            task.delay(1,function()h.WalkSpeed=defaultSpeed end)
        end
    end)
end
